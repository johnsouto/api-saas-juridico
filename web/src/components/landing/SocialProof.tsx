...
const testimonials = [
  ...
  {
    title: "Cliente Free — Em fase de organização",
    quote:
      "A curva de aprendizado é rápida. Começamos no Free e em poucos dias já estava claro onde o sistema ajuda no dia a dia."
  },
  {
          ...
          <div className="lg:col-span-5">
            ...
            <div className="mt-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs text-white/75 backdrop-blur">
              <span className="inline-flex items-center gap-1">
                <Star className="h-4 w-4 text-[#234066]" />
                <Star className="h-4 w-4 text-[#234066]" />
                <Star className="h-4 w-4 text-[#234066]" />
                <Star className="h-4 w-4 text-[#234066]" />
                <Star className="h-4 w-4 text-[#234066]" />
                ...
                <TiltCard key={t.title}>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-sm leading-relaxed text-white/70">{t.quote}</p>
                    </div>
                  </div>
                </TiltCard>
              ))}
